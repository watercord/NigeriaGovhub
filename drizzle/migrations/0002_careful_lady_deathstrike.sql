...
-- Conditional DROP logic was removed to avoid SQL dialect/runtime errors. If the
-- constraint must be removed, run the DROP manually on the database, then re-run
-- migrations.
