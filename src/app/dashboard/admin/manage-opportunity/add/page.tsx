...
export default function AddOpportunityPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-headline text-2xl">Add New Opportunity</CardTitle>
          <CardDescription>Fill in the details below to add a new opportunity.</CardDescription>
        </CardHeader>
        <CardContent>
          <OpportunityForm />
        </CardContent>
