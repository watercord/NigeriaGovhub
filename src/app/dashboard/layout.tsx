...
const DashboardSidebarContent = () => {
  ...
  const commonLinks = [
    ...
    {
      href: "/dashboard/user/bookmarked-news",
      label: t.bookmarked_news,
      icon: Bookmark,
    },
  ];
  ...
  const adminLinks = [
    ...
    {
      href: "/dashboard/admin/manage-news",
      label: t.manage_news,
      icon: Newspaper,
    },
    {
    ...
    {
      href: "/dashboard/admin/manage-videos",
      label: t.manage_videos,
      icon: PlayCircleIcon,
    },
    {
      href: "/dashboard/admin/manage-opportunity",
      label: t.manage_opportunities || "Manage Opportunities",
      icon: Newspaper,
    },
    {
      ...
      <SidebarContent>
        <ScrollArea className="h-full">
          <SidebarMenu>
            ...
            {isAdmin && (
              <>
                <SidebarMenuSubButton className="font-semibold text-muted-foreground mt-4 mb-1 px-2">
                  {t.admin_tools}
                </SidebarMenuSubButton>
                {adminLinks.map((link) => (
                  <SidebarMenuItem key={link.href}>
